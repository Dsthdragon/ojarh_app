                  ...
                  <ul class="vertical-nav-menu">
                    ...
                    <li><a href="#"><i class="metismenu-icon pe-7s-edit"></i>Account Settings<i class="metismenu-state-icon pe-7s-angle-down caret-left"></i></a>
                      <ul>
                        ...
                        <li><a href="account_details.php"><i class="metismenu-icon fa fa-cog"></i>Account Details</a></li>
                        <li><a href="seller_verification.php"><i class="metismenu-icon fa fa-user-shield"></i>Account Verification</a></li>
                      </ul>
                    </li>
                    <li><a href="#"><i class="metismenu-icon fa fa-retweet"></i>Adverts<i class="metismenu-state-icon pe-7s-angle-down caret-left"></i></a>
                      <ul>
                        <li>
          ...
          <div class="app-header">
            ...
            <div class="app-header-right">
              ...
              <div class="header-btn-lg pr-0">
                <h5 class="badge badge-info"><?php if($userDetails->role == 'Seller'){echo 'Local Market';} ?></h5>
              </div>
              <div class="header-btn-lg pr-0">
                        ...
                        <div class="widget-content p-0">
                          <div class="widget-content-wrapper">
                            <div class="widget-content-left mr-3 avatar-icon">
                                                                      ...
                                                                      <div class="widget-subheading opacity-5"><?php echo ucfirst($userDetails->lname) . ' ' . ucfirst($userDetails->fname); ?></div><div class="widget-subheading opacity-8"><?php if($userDetails->role == 'Seller'){echo 'Local Market';} ?></div>
                                                                    </div>
